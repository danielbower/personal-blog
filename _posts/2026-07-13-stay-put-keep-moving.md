...
When building digital services in the NHS these two gradients collide. There are people whose training rightly teaches them caution and people (myself included) who have been rightly taught that to keep moving *is* safer. We are observants of [Manny Lehman's Law](https://en.wikipedia.org/wiki/Lehman's_laws_of_software_evolution), know that the [ecosystem is moving](https://signal.org/blog/the-ecosystem-is-moving/), the importance of [maintainence](https://medium.com/@sarah-fisher/on-maintenance-de6787c637a0), and to [keep our head up, and our feet moving](https://medium.com/topology-insight/head-up-feet-moving-b56e60867190).

Rectifying this tension feels like a job for everyone involved. Digital folks need to show that we have moved beyond "move fast and break things" to an era when [speed and stability are not trade-offs](https://dora.dev/guides/dora-metrics/). We also need to show that doing things safely is part of our culture too, and with it comes a huge respect for our counterparts in assurance. 
...
<p id="ftn1">1. Despite being a huge fan of zombie movies their typical outlook on human behaviour doesn't really gel. When faced with disaster humans are, for the most part, <a href="https://en.wikipedia.org/wiki/A_Paradise_Built_in_Hell">a caring and compassionate bunch</a>.<a href="#ref1">↵</a>
